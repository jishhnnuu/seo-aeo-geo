...
```bash
git clone https://github.com/jishhnnuu/seo-aeo-geo.git
cd claude-seo
```
...
```
/plugin uninstall claude-seo-unified@jishnu-seo-aeo-geo
/plugin marketplace remove jishhnnuu/seo-aeo-geo
```
